...
import { USDC, USDT, WBTC, WRAPPED_NATIVE_CURRENCY, nativeOnChain } from 'uniswap/src/constants/tokens'
...
function getNativeLogoURI(chainId: UniverseChainId = UniverseChainId.Cypherium): ImageSourcePropType {
